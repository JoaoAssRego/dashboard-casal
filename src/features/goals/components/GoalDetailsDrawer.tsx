...
export function GoalDetailsDrawer({ goal, transactions, open, onOpenChange }: GoalDetailsDrawerProps) {
  ...
  // Filtra apenas os aportes desta meta
      ...
      <DrawerContent className="bg-slate-950 border-t border-indigo-500/20 max-h-[85vh]">
        <div className="mx-auto w-full max-w-md h-full flex flex-col">
          <DrawerHeader className="relative">
            ...
            <DrawerDescription className="text-indigo-200/60">Acompanhamento detalhado do seu sonho</DrawerDescription>
            <DrawerClose asChild>
          ...
          <div className="p-4 flex-1 overflow-y-auto space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-indigo-950/30 border border-indigo-500/20 shadow-lg relative overflow-hidden">
              ...
              <div className="space-y-2 mt-4 relative z-10">
                <div className="flex justify-between text-xs font-medium">
                  ...
                  <span className="text-pink-400">Faltam {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(remaining)}</span>
                </div>
